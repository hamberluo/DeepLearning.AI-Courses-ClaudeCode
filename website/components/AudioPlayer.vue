...
.play, .rate {
  flex-shrink: 0; border: 1px solid var(--vp-c-brand-1); background: transparent; color: var(--vp-c-brand-1);
...
.play:hover, .rate:hover { background: var(--vp-c-brand-soft); }
...
.fill { height: 100%; background: var(--vp-c-brand-1); border-radius: 3px; transition: width 0.1s linear; }
...
.ap-mini {
  ...
  padding: 0.5rem 0.8rem; width: min(340px, 82vw);
...
.ap-mini .play {
  ...
  border: 1px solid var(--vp-c-brand-1); background: transparent; color: var(--vp-c-brand-1); border-radius: 8px; cursor: pointer;
}
.ap-mini .play:hover { background: var(--vp-c-brand-soft); }
...
.ap-mini .fill { height: 100%; background: var(--vp-c-brand-1); border-radius: 3px; }
.ap-mini .rate { flex-shrink: 0; border: 1px solid var(--vp-c-brand-1); background: transparent; color: var(--vp-c-brand-1); border-radius: 8px; cursor: pointer; padding: 0.2rem 0.5rem; font-size: 0.75rem; font-family: var(--vp-font-family-mono); }
